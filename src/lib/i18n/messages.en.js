module.exports = {
    ...
    stepGuide: {
        title: 'Three steps to receive all emails regarding your studies at KTH to the same email address.',
        subtitle: 'Step',
        checkBox: 'I am aware that forwarding only effects emails sent to my KTH email address and I have read the information in step 1 and 2 above',
        ladok: {
            heading: 'Change your email address in Ladok (emails about registration, results, ...)',
            description: 'Change to your KTH email address or an external email address.',
            link: {
                url: 'https://www.student.ladok.se/student/#/installningar',
                displayText: 'Contact information in Ladok'
            }
        },
        antagning: {
            heading: 'Change your email address in University admissions (emails about course application)',
            description: 'Change to your KTH email address or an external email address.',
            link: {
                url: 'https://www.universityadmissions.se/',
                displayText: 'Change email address at Universityadmissions.se'
            }
        },
        kth: {
            heading: 'Set or remove forwarding of emails sent to your KTH email address.',
            description: 'If you want to use an external email service, you can set forwarding of the emails sent to your KTH email address.',
        }
    },
    forwardEmail: {
        title: 'Forwarding of your KTH emails',
        description: 'You can choose to forward emails sent to your KTH email address to an external email address. Read more about',
        link: {
            url: 'http://www.kth.se/mailforward-staff',
            displayText: 'rules governing email forwarding',
        },
    ...
    modal: {
        ...
        body: {
            info: 'When you remove email forwarding, emails sent to your KTH email address will no longer be sent to an external email address',
            verify: 'Do you want to continue and remove email forwarding?'
        },
        cancel: 'No, go back',
        confirm: 'Yes, remove',
    },
    ...
    goBack: 'Go back',
    generalError: 'Something went wrong and the changes could not be performed',
    switchLanguage: 'Denna sida på svenska',

    KTH_title: 'KTH Royal Institute of Technology',
    emailforward: 'Email forwarding',
    mega_menu: {
        title: 'Close megamenu',
        aria_label: 'Stäng'
    },
    header: {
        student: {
